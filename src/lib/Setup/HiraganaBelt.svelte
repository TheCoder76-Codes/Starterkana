...
<h1 class="text-4xl font-bold m-2">What level of Hiragana belts are you on?</h1>
<h2 class="text-2xl font-medium m-2">
	Starterkana uses Hiragana belts for progression indicators. If you don't know what level you are on, select the
	starting belt (white).
</h2>
